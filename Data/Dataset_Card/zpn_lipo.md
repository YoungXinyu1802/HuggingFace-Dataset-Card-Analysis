...
`lipo` is a dataset included in [MoleculeNet](https://moleculenet.org/). It measures the experimental results of octanol/water distribution coefficient(logD at pH 7.4)
