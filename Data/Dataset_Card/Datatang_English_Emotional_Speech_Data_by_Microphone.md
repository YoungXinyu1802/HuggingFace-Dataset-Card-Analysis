...
# Dataset Card for Datatang/English_Emotional_Speech_Data_by_Microphone
...
For more details, please refer to the link: https://bit.ly/3zZWIWl

### Supported Tasks and Leaderboards

automatic-speech-recognition, audio-speaker-identification, emotion-recognition: The dataset can be used to train a model for Automatic Speech Recognition (ASR).
