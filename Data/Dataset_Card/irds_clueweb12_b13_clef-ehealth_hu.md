---
pretty_name: '`clueweb12/b13/clef-ehealth/hu`'
viewer: false
...
The `clueweb12/b13/clef-ehealth/hu` dataset, provided by the [ir-datasets](https://ir-datasets.com/) package.
For more information about the dataset, see the [documentation](https://ir-datasets.com/clueweb12#clueweb12/b13/clef-ehealth/hu).
...
queries = load_dataset('irds/clueweb12_b13_clef-ehealth_hu', 'queries')
for record in queries:
    record # {'query_id': ..., 'text': ...}

qrels = load_dataset('irds/clueweb12_b13_clef-ehealth_hu', 'qrels')
for record in qrels:
